...
class CreateBase(SC2Action):
    ...
    def action(self, obs):
        ...
        if self._act.isFinished():
            ...
            elif self._iteration == 2:result = self._act = MoveCamera([28.5, 23.5] if self._top else [33.5, 48.5])
            ...
            elif self._iteration == 6:self._act = TrainBarracksUnits(SelectType.SINGLE, units.Terran.Marine, 5)
